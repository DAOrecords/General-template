 ...
 */
export default function MixtapeDrop({newAction, openGuestBook, setGuestBook, setShowWallet, showWallet, mixtapeName, mixtapeList}) {
  ...
  React.useEffect(async () => {    
    ...
    const filteredBuyable = buyable.filter((nft) => {
      ...
      return (mixtapeList.includes(rootId));
    });
